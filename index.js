...
document.getElementById('forms').addEventListener('submit', async function(event){
    event.preventDefault();
    let firstTask = document.getElementById('firstTask').value;
    let secondTask = document.getElementById('secondTask').value;
    let thirdTask = document.getElementById('thirdTask').value;
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log(result);
            let success = document.getElementById('add');
            success.innerHTML = "Activity added successfully";
        } else {
        ...
        console.log(error);
        let success = document.getElementById('add');
        success.innerHTML = "Failed to add activity";
    }
});
